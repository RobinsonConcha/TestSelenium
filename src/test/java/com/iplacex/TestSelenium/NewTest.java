...
public class NewTest {
  ...
  public void f() {
	  ...
	  cuadroBusqueda.sendKeys("http://localhost:8080/Integracion/index.jsp");
	  ...
	  assertEquals("http://localhost:8080/Integracion/index.jsp - Buscar con Google", driver.getTitle());
  }
